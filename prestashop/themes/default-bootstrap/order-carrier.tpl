			...
			<div class="delivery_options_address">
				...
				{if $opc}
					<div class="form-group">
						<label for="message">{l s='Leave a message'}</label>
						<textarea class="form-control" cols="120" rows="2" name="message" id="message" placeholder="{l s='If you would like to add a comment about your order, please write it in the field below.'}">{strip}
