<div id="opc_new_account" class="opc-main-block">
	...
	<p><a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" class="openLoginFormBlock">&raquo; {l s='Click here'}</a></p>
	</div>
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="login-form">
		...
		<fieldset class="form-group">
				...
				<h3 class="page-subheading">{l s='Login Form'}</h3>
				...
				<p class="submit">
					...
					<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-primary btn-block">{l s='Sign in'}</button>
				</p>
		</fieldset>
	</form>
	<div class="login-form__overlay"></div>
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			<div class="box">
				...
				<div id="opc_account_form" class="form unvisible">
					...
					<div class="required text form-group">
						...
						<small class="is_registred"></small> 
					</div>
					
					<div class="checkbox">
						<label for="is_customer">
						<input type="checkbox" name="is_customer" id="is_customer" value="1" autocomplete="off"/>
						{l s='Create Account'}</label>
					</div>

					<div class="required password is_customer_param create_account form-group">
...
{* 					{elseif $field_name eq "vat_number"}
					...
					<div class="text{if !in_array($field_name, $required_fields)} is_customer_param create_account{/if} form-group">
					...
					{/if}
					<div class="form-group is_customer_param create_account">
					...
					<div id="opc_invoice_address" class="is_customer_param">
						...
						{elseif $field_name eq "vat_number"}
						<div id="vat_number_block_invoice" class="is_customer_param create_account" style="display:none;">
							<div class="form-group">
						...
						{elseif $field_name eq "address2"}
						<div class="form-group{if !in_array($field_name, $required_fields)} is_customer_param create_account{/if}">
						...
						{if isset($one_phone_at_least) && $one_phone_at_least}
							<p class="inline-infos required is_customer_param create_account">{l s='You must register at least one phone number.'}</p>
						{/if}
						<div class="form-group is_customer_param create_account">
...
{addJsDefL name='login'}{l s='Please Log in' js=1}{/addJsDefL}
