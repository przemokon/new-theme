...
<ul class="display hidden-xs">
    ...
    <li id="grid"><a rel="nofollow" href="#" title="{l s='Grid'}"><i class="icon icon-fw icon-th-large"></i>{l s='Grid'}</a></li>
    <li id="list"><a rel="nofollow" href="#" title="{l s='List'}"><i class="icon icon-fw icon-th-list"></i>{l s='List'}</a></li>
</ul>
